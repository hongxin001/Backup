...
0
|| checktplrefresh('./template/strong_mobile/touch/member/login.htm', './template/strong_mobile/touch/common/seccheck.htm', 1415016021, '3', './data/template/3_3_touch_member_login.tpl.php', './template/strong_mobile', 'touch/member/login')
