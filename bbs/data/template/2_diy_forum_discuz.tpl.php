...
<study_addnew><a onclick="showWindow('nav','forum.php?mod=misc&amp;action=nav')" title="<?php echo $cmszs_lang['2'];?>" style="cursor:pointer;" data-text="<?php echo $cmszs_lang['2'];?>" class="quick-thread btn-base" target="_blank"><?php echo $cmszs_lang['3'];?></a></study_addnew>
</div>
...
<div class="fl bm noborder block-list radius5">
<?php if(!empty($collectiondata['follows'])) { $forumscount = count($collectiondata['follows']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="bm bmw <?php if($forumcolumns) { ?> flg<?php } ?> cl grep15">
...
<?php } if(empty($gid) && !empty($forum_favlist)) { $forumscount = count($forum_favlist);?><?php $forumcolumns = $forumscount > 3 ? ($forumscount == 4 ? 4 : 5) : 1;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="bm bmw <?php if($forumcolumns) { ?> flg<?php } ?> cl  grep15">
<div class="bm_h cl noborder radius5 block-item">
<span class="o">
...
<div class="bm bmw <?php if($forumcolumns) { ?> flg<?php } ?> cl  grep15">
<div class="bm_h cl noborder radius5 block-item">
<span class="o">
...
</div><?php echo adshow("intercat/bm a_c/$cat[fid]");?><?php } if(!empty($collectiondata['data'])) { $forumscount = count($collectiondata['data']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="bm bmw <?php if($forumcolumns) { ?> flg<?php } ?> cl  grep15">
<div class="bm_h cl noborder radius5 block-item">
<span class="o">
<img id="category_-2_img" src="<?php echo $_G['style']['styleimgdir'];?>/<?php echo $collapse['collapseimg_-2'];?>" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('category_-2');" />
</span>
