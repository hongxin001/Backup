...
0
|| checktplrefresh('./template/cmszs_360bbs/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1415023234, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/cmszs_360bbs', 'forum/forumdisplay')
|| checktplrefresh('./template/cmszs_360bbs/forum/forumdisplay.htm', './template/cmszs_360bbs/forum/recommend.htm', 1415023234, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/cmszs_360bbs', 'forum/forumdisplay')
|| checktplrefresh('./template/cmszs_360bbs/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1415023234, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/cmszs_360bbs', 'forum/forumdisplay')
|| checktplrefresh('./template/cmszs_360bbs/forum/forumdisplay.htm', './template/cmszs_360bbs/forum/forumdisplay_list.htm', 1415023234, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/cmszs_360bbs', 'forum/forumdisplay')
|| checktplrefresh('./template/cmszs_360bbs/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1415023234, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/cmszs_360bbs', 'forum/forumdisplay')
|| checktplrefresh('./template/cmszs_360bbs/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1415023234, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/cmszs_360bbs', 'forum/forumdisplay')
|| checktplrefresh('./template/cmszs_360bbs/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1415023234, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/cmszs_360bbs', 'forum/forumdisplay')
...
<div class="boardnav">
<div id="ct" class="wp cl"<?php if($leftside) { ?> style="margin-left:<?php echo $_G['leftsidewidth_mwidth'];?>px"<?php } ?>>
<?php if($leftside) { ?>
...
<div class=" cl">
                    ...
                    <?php if($moderatedby) { ?><div class="banzhu">版主: <span class="xi2"><?php echo $moderatedby;?></span></div><?php } ?>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" class="tit-tag"><?php echo $_G['forum']['name'];?></a>
                        <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" id="a_favorite" class="fa_fav" onclick="showWindow(this.id, this.href, 'get', 0);">收藏本版</a>
<?php if(!$subforumonly) { ?><span class="xs1 xw0 i">今日: <strong class="xi1"><?php echo $_G['forum']['todayposts'];?></strong><?php if($_G['forum']['todayposts']) { if($_G['forum']['todayposts'] < $_G['forum']['yesterdayposts']) { ?><b class="ico_fall">&nbsp;</b><?php } else { ?><b class="ico_increase">&nbsp;</b><?php } } ?><span class="pipe">|</span>主题: <strong class="xi1"><?php echo $_G['forum']['threads'];?></strong><?php if($_G['forum']['rank']) { ?><span class="pipe">|</span>排名: <strong class="xi1" title="上次排名:<?php echo $_G['forum']['oldrank'];?>"><?php echo $_G['forum']['rank'];?></strong><?php if($_G['forum']['rank'] <= $_G['forum']['oldrank']) { ?><b class="ico_increase">&nbsp;</b><?php } else { ?><b class="ico_fall">&nbsp;</b><?php } } ?></span><?php } ?>
                ...
                <?php if($_G['forum']['banner'] && !$subforumonly) { ?><img src="<?php echo $_G['forum']['banner'];?>" alt="<?php echo $_G['forum']['name'];?>" /><?php } if((!empty($_G['forum']['domain']) && !empty($_G['setting']['domain']['root']['forum'])) || $moderatedby || ($_G['page'] == 1 && $_G['forum']['rules'])) { ?>
...
<div class="thread-list-box <?php if($_G['forum']['allowside']) { ?>cmszsct2<?php } ?>">
...
<?php } if($_G['forum']['allowside']) { } else { ?>
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><?php echo $cmszs_lang['1'];?></a><?php } ?>
...
<?php if(empty($_G['forum']['sortmode'])) { ?><div id="threadlist" class="tl bm bmw  noborder radius5 block-list"<?php if($_G['uid']) { ?> style="position: relative;"<?php } ?>>
<?php if(!$_G['forum']['allowside']) { ?>
<style>
#threadlist .bm_c .new {width: 845px;float: left;}
#threadlist .bm_c .common {width: 845px;float: left;}
</style>
<?php } if(($_G['forum']['threadtypes'] && $_G['forum']['threadtypes']['listable']) || count($_G['forum']['threadsorts']['types']) > 0) { if($leftside||$_G['forum']['allowside']) { ?>
<style>
...
<li id="ttp_all" <?php if(!$_GET['typeid'] && !$_GET['sortid']) { ?>class="xw1 a"<?php } ?>><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?><?php if($_G['forum']['threadsorts']['defaultshow']) { ?>&amp;filter=sortall&amp;sortall=1<?php } if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">全部</a><span class="type-pipe"></span></li>
...
<th class="<?php echo $thread['folder'];?>">
                                    	<em class="view-num view-num-color"><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></em>
...
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_thread'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_thread'][$key];?>
                                        <style>
                                        .type-tag em a:hover {color: #fff;background: #40b60f;}
.type-tag em a {color: #40b60f;}
.type-tag em a {border: 1px solid #40b60f;display: inline-block;vertical-align: middle;padding: 0px 6px;_font-size: 11px;}
.type-tag em a{-webkit-border-radius: 2px;-moz-border-radius: 2px;border-radius: 2px;}
                                        </style>
<span class="type-tag"><?php echo $thread['typehtml'];?></span>
<?php if($thread['moved']) { ?>
...
<?php } } ?>
                                        <div>
<a href="thread-3566672-1-1.html" class="xi2 reply-num"><?php echo $thread['allreplies'];?></a>
<cite class="thread-author"> 
<a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1"<?php if($groupcolor[$thread['authorid']]) { ?> style="color: <?php echo $groupcolor[$thread['authorid']];?>;"<?php } ?>><?php echo $thread['author'];?></a><?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } ?></cite>
<em><?php echo $cmszs_lang['10'];?>&nbsp;<span><?php echo $thread['dateline'];?></span>&nbsp;<?php echo $cmszs_lang['11'];?></em><span class="pipe">|</span>
<cite class="thread-author">
<?php if($thread['lastposter']) { ?><a href="<?php if($thread['digest'] != -2) { ?>home.php?mod=space&username=<?php echo $thread['lastposterenc'];?><?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>&page=<?php echo max(1, $thread['pages']);; } ?>" c="1"><?php echo $thread['lastposter'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?></cite>
<em>&nbsp;<?php echo $cmszs_lang['10'];?>&nbsp;<a href="<?php if($thread['digest'] != -2 && !$thread['ordertype']) { ?>forum.php?mod=redirect&tid=<?php echo $thread['tid'];?>&goto=lastpost<?php echo $highlight;?>#lastpost<?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?><?php if(!$thread['ordertype']) { ?>&page=<?php echo max(1, $thread['pages']);; } } ?>"><?php echo $thread['lastpost'];?></a>&nbsp;<?php echo $cmszs_lang['9'];?></em>
</div>
</th>
...
<?php } if($_G['forum']['ismoderator'] && $_G['forum_threadcount']) { include template('forum/topicadmin_modlayer'); } ?>
    ...
    <div class="bm bw0 pgs cl cmszs_prevnext" style="width:560px;">
...
<span id="fd_page_bottom"><?php echo $multipage;?></span>
<span <?php if($_G['setting']['visitedforums']) { ?>id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"<?php } ?> class="pgb y"><a href="forum.php">返&nbsp;回</a></span>
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">
    <?php echo $cmszs_lang['1'];?>
    </a><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_postbutton_bottom'])) echo $_G['setting']['pluginhooks']['forumdisplay_postbutton_bottom'];?>
</div>
...
<div id="pgt" class="bm bw0 pgs cl">
<a href="javascript:;" id="newspecial" class="btn-base" <?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><?php echo $cmszs_lang['3'];?></a></div>
<?php if($_G['forum']['rules']) { ?>
<div id="forum_rules_<?php echo $_G['fid'];?>" style="<?php echo $collapse['forum_rules'];?>;" class="forum_rules radius5">
<div class="ptn xg2"><?php echo $_G['forum']['rules'];?></div>
</div>
<?php } ?>
<div class="gg-sidebar-hotblock radius5 cl gg-sidebar">
<h4><?php echo $cmszs_lang['12'];?></h4>
<a href="forum.php" target="_blank" class="more"><?php echo $cmszs_lang['15'];?></a>
<div style='clear:both'>
<!--[diy=cmszs_hotbk]--><div id="cmszs_hotbk" class="area"></div><!--[/diy]-->
</div>
</div>
<div class="mod-b radius5">
          <h2><?php echo $cmszs_lang['7'];?></h2>
