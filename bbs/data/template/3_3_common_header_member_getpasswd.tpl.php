...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1416036149, '3', './data/template/3_3_common_header_member_getpasswd.tpl.php', './template/strong_mobile', 'common/header_member_getpasswd')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1416036149, '3', './data/template/3_3_common_header_member_getpasswd.tpl.php', './template/strong_mobile', 'common/header_member_getpasswd')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1416036149, '3', './data/template/3_3_common_header_member_getpasswd.tpl.php', './template/strong_mobile', 'common/header_member_getpasswd')
;?>
