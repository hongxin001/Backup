...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1415279674, '3', './data/template/3_3_common_header_home_invite.tpl.php', './template/strong_mobile', 'common/header_home_invite')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1415279674, '3', './data/template/3_3_common_header_home_invite.tpl.php', './template/strong_mobile', 'common/header_home_invite')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1415279674, '3', './data/template/3_3_common_header_home_invite.tpl.php', './template/strong_mobile', 'common/header_home_invite')
;?>
