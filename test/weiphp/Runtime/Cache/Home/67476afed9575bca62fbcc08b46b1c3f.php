                    ...
                    <div class="controls">
                      <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value=""><?php break;?>
                        ...
                        <?php case "radio": $_result=parse_field_attr($field['extra']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="check-item">
                              ...
                              <input type="radio" value="<?php echo ($key); ?>" id="<?php echo ($field["name"]); ?>_<?php echo ($key); ?>" class="regular-radio" name="<?php echo ($field["name"]); ?>">
                        ...
                        <?php case "checkbox": $_result=parse_field_attr($field['extra']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="check-item">
                              <input type="checkbox" value="<?php echo ($key); ?>" class="regular-checkbox" id="<?php echo ($field["name"]); ?>_<?php echo ($key); ?>" name="<?php echo ($field["name"]); ?>[]">
                              <label for="<?php echo ($field["name"]); ?>_<?php echo ($key); ?>"></label><?php echo ($vo); endforeach; endif; else: echo "" ;endif; break;?>
                        <?php case "editor": ?><label class="textarea" style="width:600px">
                            <textarea name="<?php echo ($field["name"]); ?>"></textarea>
                            <?php echo hook('adminArticleEdit', array('name'=>$field['name'],'value'=>''));?> </label><?php break;?>
